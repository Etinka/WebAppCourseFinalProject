...
namespace WebAppCourseFinalProject
{
    public class BranchesController : BaseController
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Subtitle,Longtitude,Latitude")] Branch branch)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Subtitle,Longtitude,Latitude")] Branch branch)
        {
            if (id != branch.Id)
            {
                return NotFound();
